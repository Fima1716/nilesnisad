...
export const ru = {
  ...
  product: {
    ...
    reviewsShort: (n: number) => `${n} ${plural(n, "отзыв", "отзыва", "отзывов")}`,
    questions: (n: number) => `Вопросы ${n}`,
    deliveryTomorrow: "Доставим завтра",
    collectible: "Коллекционный сорт",
    graftedSeedling: "Привитой саженец",
    buyNow: "Купить сейчас",
    article: (n: number) => `Артикул: ${n}`,
    noPhoto: "Фото сорта готовим",
    latinName: "Латинское название",
    outOfStock: "Нет в наличии",
    ratingNoReviews: "Пока без отзывов",
    containerChoice: "Объём горшка",
    liters: (volume: string) => `${volume} л`,
  },
